...
Je suis présentement à la recherche de nouveaux étudiants aux cycles supérieurs (maîtrise et doctorat) pour plusieurs [projets de recherche](http://alesagelandry.github.io//Users/alesagelandry/Library/CloudStorage/Dropbox/Antoine/Antoine_National_Library/LaTeX/MScPhDPositions/MScPhD_LORER_fr.pdf). J’invite les étudiant.e.s intéressé.e.s à entreprendre une maîtrise ou un doctorat sous ma supervision à me contacter. Pour plus d'information sur le processus d'application, s'il vous plaît consulter la description de projet.
